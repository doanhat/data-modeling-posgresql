...
class DumpJson:
    ...
    def dumpFile(self):
        ...
        jsonFile = open("G:/Coding/Data_Pipeline_Project/data_modeling_posgresql/data/json/TRAAAAW128F429D538.json", "w")
        jsonFile.write(json.dumps(self.json, sort_keys=True, indent=4))
        jsonFile.close()
...
def main():
    ...
    filename = "G:/Coding/Data_Pipeline_Project/data_modeling_posgresql/data/song_data/A/A/A/TRAAAAW128F429D538.h5"
